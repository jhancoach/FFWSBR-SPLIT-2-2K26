...
export const TeamVsTeamCombatCompare: React.FC<TeamVsTeamCombatCompareProps> = ({
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
        ...
        <div className="p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-white/5">
              ...
              <span className="text-[10px] font-bold text-gray-500 uppercase">
                {tA.victimTeams.length} times abatidos
              </span>
            </div>

            <div className="space-y-2.5">
              {tA.victimTeams.length > 0 ? (
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-white/5">
              ...
              <span className="text-[10px] font-bold text-gray-500 uppercase">
                {tB.victimTeams.length} times abatidos
              </span>
            </div>

            <div className="space-y-2.5">
              {tB.victimTeams.length > 0 ? (
        ...
        <div className="p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-white/5">
              ...
              <span className="text-[10px] font-bold text-gray-500 uppercase">
                {tA.killerTeams.length} times algozes
              </span>
            </div>

            <div className="space-y-2.5">
              {tA.killerTeams.length > 0 ? (
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-white/5">
              ...
              <span className="text-[10px] font-bold text-gray-500 uppercase">
                {tB.killerTeams.length} times algozes
              </span>
            </div>

            <div className="space-y-2.5">
              {tB.killerTeams.length > 0 ? (
        ...
        <div className="p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-white/5">
              ...
              <span className="text-[10px] font-bold text-gray-500 uppercase">
                {tA.victimPlayers.length} jogadores abatidos
              </span>
            </div>

            <div className="space-y-2.5">
              {tA.victimPlayers.length > 0 ? (
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-white/5">
              ...
              <span className="text-[10px] font-bold text-gray-500 uppercase">
                {tB.victimPlayers.length} jogadores abatidos
              </span>
            </div>

            <div className="space-y-2.5">
              {tB.victimPlayers.length > 0 ? (
        ...
        <div className="p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-white/5">
              ...
              <span className="text-[10px] font-bold text-gray-500 uppercase">
                {tA.killerPlayers.length} jogadores algozes
              </span>
            </div>

            <div className="space-y-2.5">
              {tA.killerPlayers.length > 0 ? (
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-white/5">
              ...
              <span className="text-[10px] font-bold text-gray-500 uppercase">
                {tB.killerPlayers.length} jogadores algozes
              </span>
            </div>

            <div className="space-y-2.5">
              {tB.killerPlayers.length > 0 ? (
      ...
      {/* ========================================================================= */}
      {/* SEÇÃO X: ARMAS QUE MAIS MATAM E ARMAS ALGOZES (EQUIPES) */}
      {/* ========================================================================= */}
                      ...
                      <div key={idx} className="bg-black/50 p-3 rounded-2xl border border-white/5 flex items-center justify-between gap-3">
                        <div className="flex items-center gap-3 min-w-0">
                          ...
                          <div className="min-w-0">
                            ...
                            <span className="text-[8px] text-gray-500 font-bold uppercase">Arma da Equipe</span>
                          </div>
                        </div>
                        <div className="flex items-center gap-3 flex-shrink-0">
