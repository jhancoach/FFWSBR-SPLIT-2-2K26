...
POSIÇÃO ({selectedTeamStats.percentPos}%){" "}
<Target size={10} />
</span>
</div>
...
* Distribuição baseada na origem dos pontos totais da
equipe.
</p>
</div>
</div>
...
<Layers size={14} className="text-yellow-400" /> Seções
do Time
</span>
...
{
key: "evolution",
label: "9. Histórico de Performance",
icon: TrendingUp,
},
{
key: "territorial",
label: "10. Domínio Territorial (Mapas)",
icon: MapIcon,
},
{
key: "safesDistribution",
label: "11. Distribuição por Safe",
icon: Disc,
},
{
key: "positions",
label: "12. Sumário de Posições",
icon: Trophy,
},
{
key: "drops",
...
CARACTERÍSTICAS DA EQUIPE ({selectedTeamStats?.name}) EM
CADA MAPA
</p>
</div>
<button
...
Detalhamento de partidas onde o time zerou (não conquistou
pontos e/ou não realizou abates)
</p>
</div>
<div className="flex flex-wrap items-center gap-2">
...
<span className="text-[9px] text-gray-400 font-medium block">
Nenhuma eliminação conquistada
</span>
</div>
<div className="bg-black/60 p-4 rounded-2xl border border-white/5 space-y-1">
<span className="text-[9px] font-black text-gray-500 uppercase tracking-widest block">
...
<span className="text-[9px] text-gray-400 font-medium block">
Mapa com maior número de quedas zeradas
</span>
</div>
</div>
...
Queda. Clique em qualquer célula para ver os detalhes
...
Média: {teamRoundsAndDropsMatrix.summary.avgPtsPerMatch}/Q
</span>
</div>
<div className="bg-black/60 p-3.5 rounded-2xl border border-white/5 text-center">
<span className="text-[9px] font-black text-gray-500 uppercase tracking-widest block">
...
<span className="text-[8px] text-gray-400 block font-mono">
Média: {teamRoundsAndDropsMatrix.summary.avgKillsPerMatch}
/Q
</span>
</div>
<div className="bg-black/60 p-3.5 rounded-2xl border border-white/5 text-center">
...
<Crown size={16} /> 🟢 MELHORES SAFES (MAIOR
APROVEITAMENTO)
</div>
...
<AlertTriangle size={16} /> 🔴 PIORES SAFES (MENOR
APROVEITAMENTO)
</div>
<div className="space-y-2.5">
...
/>{" "}
Distribuição de Abates por Fase de Safe (Killfeed)
</h5>
...
/>{" "}
Todos os Abates e Estatísticas por Safe (
{mapGroup.mapName})
</h5>
...
<p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider mt-1">
Análise detalhada do volume de abates e médias por rodada
em cada mapa, juntamente com a identificação do MVP e
...
FORMAÇÕES (LINEUPS) DA EQUIPE •{" "}
<span className="text-indigo-400">
{selectedTeamStats?.name || activeTeamName}
</span>
</h3>
<p className="text-xs text-gray-400 font-bold uppercase tracking-widest mt-1">
Análise dos quartetos de jogadores: quem jogou mais
...
Formação com {lineup.players.length}{" "}
Atletas
</span>
</div>
...
/>{" "}
Ocultar Quedas Desta Formação
</>
) : (
<>
<ChevronDown size={14} /> Ver Histórico de
...
Verifique se há filtros de Rodada, Queda ou Mapa ativos
...
COMPOSIÇÃO E HABILIDADES DA EQUIPE (
{selectedTeamStats.name})
</h3>
<p className="text-[10px] text-gray-500 font-bold uppercase tracking-wider mt-0.5">
Resumo das habilidades ativas, pets e preferências da
...
PREFERÊNCIAS POR JOGADOR NA LINE-UP
</span>
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
...
<p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider mt-1">
Análise da distribuição de abates da equipe baseada nas
...
+ {teamPhaseStats.otherKills} abates em safes não
identificadas
</div>
)}
</div>
...
<div className="bg-[#1a1a1a] p-8 rounded-3xl border border-gray-800 shadow-xl">
<h3 className="text-white font-black text-sm mb-8 flex items-center gap-3 uppercase tracking-widest">
<MapIcon size={20} className="text-blue-500" /> DOMÍNIO
...
<div className="bg-[#1a1a1a] p-8 rounded-3xl border border-gray-800 shadow-xl">
<h3 className="text-white font-black text-sm mb-8 flex items-center gap-3 uppercase tracking-widest">
<Disc size={20} className="text-red-500" /> DISTRIBUIÇÃO
POR SAFE
</h3>
...
<div className="bg-[#1a1a1a] p-8 rounded-3xl border border-gray-800 shadow-xl">
<h3 className="text-white font-black text-sm mb-8 flex items-center gap-3 uppercase tracking-widest">
<Trophy size={20} className="text-yellow-500" /> SUMÁRIO DE
POSIÇÕES (CLIQUE)
</h3>
<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
...
Descubra quais times mais ficaram em cada colocação específica
(do 1º ao 12º lugar), taxas de Booyah, Top 3, Top 6 e
...
{team.name} terminou em {pos}º Lugar
</h4>
<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
...
Clique em qualquer cabeçalho de coluna (1º, 2º, 3º... 12º,
Top 3, Top 6, Média) para ordenar os times por aquela
colocação.
</p>
</div>
<div className="flex items-center gap-2">
...
Acompanhe o ranking de mapas por abates, média de abates por
...
<p className="text-xs text-gray-400 font-medium">
Classificação geral dos mapas com médias calculadas por
partida disputada.
</p>
</div>
{/* Search */}
...
<p className="text-xs text-gray-400 font-medium">
Detalhamento por rodada do volume de abates e médias por
...
<p className="text-xs text-gray-400 font-medium tracking-wide mt-1">
Acompanhe o desempenho, pontuação, abates, médias por
partida e eficiência de cada equipe em cada território do
campeonato.
</p>
</div>
</div>
...
<div className="text-base font-black text-white">
{mapRankings.length} Territórios
</div>
</div>
</div>
</div>
...
<th className="px-3 py-3 text-center w-28">Ação</th>
</tr>
</thead>
...
{
label: "Média de Abates",
key: "avgAbts",
color: "text-white",
},
{
label: "Média Pts Posição",
key: "avgPtsc",
color: "text-blue-400",
},
{
...
Histórico head-to-head por rodada
</span>
</div>
</div>
...
if (allRds.length === 0) {
return (
<span className="text-[10px] text-gray-600 italic block text-center py-4">
Sem dados por rodada
</span>
);
}
return allRds.map((rd) => {
const rdA = m.teamA.roundsList.find(
(r) => r.rd === rd,
);
const rdB = m.teamB.roundsList.find(
(r) => r.rd === rd,
);
...
>
<span
className={`w-8 text-left font-black ${isGreaterA ? "text-yellow-500 scale-105 font-extrabold" : "text-gray-500"}`}
>
{killsA}
</span>
<span className="text-[8px] text-gray-600 font-black uppercase bg-black/50 px-2 py-1 rounded-md border border-white/5 min-w-[50px] text-center">
{rd}
</span>
<span
className={`w-8 text-right font-black ${isGreaterB ? "text-blue-400 scale-105 font-extrabold" : "text-gray-500"}`}
>
{killsB}
</span>
</div>
...
<span className="text-[10px] text-blue-400 font-black uppercase tracking-widest block border-b border-white/5 pb-2">
MVP & Elenco ({compareTeamB})
</span>
{m.teamB.mvpPlayer ? (
...
<img
src={m.teamB.mvpPlayer.playerImg}
alt={m.teamB.mvpPlayer.name}
referrerPolicy="no-referrer"
className="w-full h-full object-cover"
/>
) : (
...
<div className="absolute top-0 left-0 bg-blue-500 text-white px-1 py-0.5 rounded-br text-[6px] font-black uppercase">
MVP
</div>
</div>
<div className="min-w-0">
<span className="block text-xs font-black text-white truncate">
{m.teamB.mvpPlayer.name}
</span>
<span className="block text-[8px] text-gray-500 font-bold uppercase">
{m.teamB.mvpPlayer.kills} kills (
{m.teamB.mvpPlayer.avgKills} avg)
</span>
</div>
</div>
) : (
...
<span className="text-[9px] text-gray-500 font-bold uppercase tracking-wider">
Locais onde as equipes mais pontuam ou falham
</span>
</div>
</div>
</div>
...
{/* Team A Safes */}
<div className="space-y-4">
<span className="text-xs font-black text-yellow-500 uppercase tracking-widest block border-b border-white/5 pb-2">
{filters.team[0]}
</span>
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
{/* Best */}
<div className="bg-emerald-950/20 p-4 rounded-2xl border border-emerald-500/20 space-y-3">
<span className="text-[9px] text-emerald-400 font-black uppercase tracking-wider flex items-center gap-2">
<ArrowUp size={12} /> MELHORES SAFES
</span>
{m.teamA.best.length > 0 ? (
m.teamA.best.map((s, idx) => (
<div
key={idx}
className="flex justify-between items-center text-xs"
>
...
<span className="text-[9px] text-red-400 font-black uppercase tracking-wider flex items-center gap-2">
<ArrowDown size={12} /> PIORES SAFES
</span>
{m.teamA.worst.length > 0 ? (
m.teamA.worst.map((s, idx) => (
<div
key={idx}
className="flex justify-between items-center text-xs"
>
...
{/* Team B Safes */}
<div className="space-y-4">
<span className="text-xs font-black text-blue-400 uppercase tracking-widest block border-b border-white/5 pb-2">
{compareTeamB}
</span>
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
{/* Best */}
...
{m.teamB.best.length > 0 ? (
m.teamB.best.map((s, idx) => (
<div
key={idx}
className="flex justify-between items-center text-xs"
>
...
{m.teamB.worst.length > 0 ? (
m.teamB.worst.map((s, idx) => (
<div
key={idx}
className="flex justify-between items-center text-xs"
>
...
<div>
<h4 className="text-xl font-black text-white uppercase italic tracking-widest">
Agressividade (Early / Mid / Late)
</h4>
<span className="text-[9px] text-gray-500 font-bold uppercase tracking-wider">
Comparativo de kills por fase no Kill Feed
</span>
</div>
</div>
</div>
...
{[filters.team[0], compareTeamB].map((teamName, idx) => {
const phaseStats = allTeamsPhaseStats.find(
(t) => t.name === teamName,
);
...
<h5
className={`text-xl font-black uppercase italic tracking-widest ${idx === 0 ? "text-yellow-500" : "text-blue-400"}`}
>
{teamName}
</h5>
<div className="space-y-4">
...
Kills no início de partida
</span>
</div>
<div className="flex flex-col items-end">
<span className="text-2xl font-black text-white italic">
{phaseStats.earlyKills}{" "}
<span className="text-xs text-emerald-400 ml-1 font-bold">
KILLS
</span>
</span>
<span className="text-[10px] text-emerald-400/80 font-black">
{phaseStats.earlyPct}%
</span>
</div>
</div>
...
<span className="text-xs text-gray-500 font-bold">
Kills no meio de jogo
</span>
</div>
<div className="flex flex-col items-end">
<span className="text-2xl font-black text-white italic">
{phaseStats.midKills}{" "}
<span className="text-xs text-yellow-400 ml-1 font-bold">
KILLS
</span>
</span>
<span className="text-[10px] text-yellow-400/80 font-black">
{phaseStats.midPct}%
</span>
</div>
</div>
...
<div className="flex flex-col items-end">
<span className="text-2xl font-black text-white italic">
{phaseStats.lateKills}{" "}
<span className="text-xs text-red-400 ml-1 font-bold">
KILLS
</span>
</span>
<span className="text-[10px] text-red-400/80 font-black">
{phaseStats.latePct}%
</span>
</div>
</div>
...
<span className="text-lg font-black text-white italic">
{phaseStats.totalPhaseKills} KILLS
</span>
</div>
</div>
);
...
Selecione duas equipes nos campos acima para comparar
...
<BottomList
title="Piores em Pontos"
data={bottomRankings.pts}
metric="pts"
label="PTS"
color="text-yellow-500"
onSelect={(name) =>
setFilters((prev) => ({ ...prev, team: [name] }))
}
/>
<BottomList
title="Piores em PTS/C"
data={bottomRankings.ptsc}
metric="ptsc"
label="PTS/C"
color="text-orange-500"
onSelect={(name) =>
...
/>
<BottomList
title="Piores em Booyahs"
data={bottomRankings.booyahs}
metric="b"
label="BOOYAHS"
color="text-blue-500"
onSelect={(name) =>
...
/>
<BottomList
title="Piores Médias (PTS)"
data={bottomRankings.avgPts}
metric="avgPts"
label="AVG PTS"
color="text-yellow-400"
onSelect={(name) =>
...
/>
<BottomList
title="Piores Médias (KILLS)"
data={bottomRankings.avgAbts}
metric="avgAbts"
label="AVG KILLS"
color="text-red-500"
onSelect={(name) =>
...
<span className="text-[9px] text-gray-400 font-black uppercase tracking-widest bg-black/40 px-3 py-1.5 rounded-lg border border-white/5 flex items-center gap-2">
<span className="w-2 h-2 rounded bg-[#10b981] inline-block shadow-[0_0_8px_rgba(16,185,129,0.5)]"></span>{" "}
FINALISTAS (2-12º)
</span>
<span className="text-[9px] text-gray-400 font-black uppercase tracking-widest bg-black/40 px-3 py-1.5 rounded-lg border border-white/5 flex items-center gap-2">
<span className="w-2 h-2 rounded bg-red-700 inline-block shadow-[0_0_8px_rgba(239,68,68,0.4)]"></span>{" "}
REBAIXAMENTO (13º+)
</span>
</div>
</div>
...
<th
key={round}
className="px-4 py-4 text-center min-w-[80px] font-bold text-gray-300"
>
...
const rank = index + 1;
const trend = rankTrends[team.name] || {
change: 0,
type: "neutral",
};
...
if (rank <= 12) {
rowBorderClass +=
"border-l-[4px] border-[#10b981] bg-emerald-500/[0.01]";
} else {
rowBorderClass +=
...
<td
key={round}
className="px-4 py-3 text-center font-bold text-xs font-mono"
>
{isExistent ? (
<span className="text-white font-black">
{pts}
...
<div>
<h3 className="text-xl font-black text-white uppercase italic tracking-widest flex items-center gap-3">
<Calendar size={20} className="text-yellow-500" /> HISTÓRICO
DE RODADAS POR EQUIPE
</h3>
<p className="text-xs text-gray-500 font-bold uppercase tracking-wider mt-1">
Visualize quais rodadas uma equipe jogou e os detalhes de sua
performance em cada queda
</p>
</div>
</div>
{/* Seleção de equipe */}
...
<h4 className="text-lg font-black italic uppercase leading-none text-white truncate">
{selectedTeamStats.name}
</h4>
{selectedTeamStats.grupo && (
<span className="text-[8px] text-yellow-500 font-bold uppercase tracking-widest mt-1 block">
{selectedTeamStats.grupo}
</span>
)}
</div>
...
<span className="text-[8px] text-gray-500 font-black uppercase tracking-widest block mb-1">
PONTOS TOTAIS
</span>
<span className="text-2xl font-black italic leading-none text-yellow-500">
{selectedTeamStats.pts}
</span>
</div>
<div className="bg-black/40 rounded-2xl p-4 border border-white/5 text-center flex flex-col justify-center">
<span className="text-[8px] text-gray-500 font-black uppercase tracking-widest block mb-1">
...
<span className="text-2xl font-black italic leading-none text-red-500">
{selectedTeamStats.abts}
</span>
</div>
<div className="bg-black/40 rounded-2xl p-4 border border-white/5 text-center flex flex-col justify-center">
<span className="text-[8px] text-gray-500 font-black uppercase tracking-widest block mb-1">
...
<span className="text-2xl font-black italic leading-none text-orange-500">
{selectedTeamStats.b}
</span>
</div>
</div>
...
<p className="text-[10px] text-gray-500 font-bold uppercase tracking-wider mt-0.5">
Resumo das habilidades ativas, pets e preferências da
line-up em {teamCharSummary.totalDrops} quedas
disputadas
</p>
</div>
</div>
...
className="cursor-pointer"
onClick={() =>
setTeamRoundsMapFilter(
isSelected ? "ALL" : m.mapName,
)
}
>
<div className="flex justify-between items-center mb-2">
...
return (
normM === normF ||
normM.includes(normF) ||
normF.includes(normM)
);
});
...
<div
key={rdData.round}
className="bg-black/30 rounded-2xl border border-gray-800 overflow-hidden shadow-lg"
>
{/* Cabeçalho da Rodada */}
...
<span
key={conf}
className="bg-white/5 border border-white/5 text-[8px] font-black uppercase text-gray-400 px-2 py-0.5 rounded"
>
{conf}
</span>
))}
...
<span className="block text-[7px] text-gray-500 font-black uppercase tracking-widest">
Pontos
</span>
<span className="text-xs font-black text-yellow-500 leading-none mt-1 inline-block">
{rdData.pts}
</span>
</div>
<div className="text-center bg-black/60 px-3 py-1.5 rounded-xl border border-white/5 min-w-[70px]">
...
<span className="text-xs font-black text-red-500 leading-none mt-1 inline-block">
{rdData.abts}
</span>
</div>
<div className="text-center bg-black/60 px-3 py-1.5 rounded-xl border border-white/5 min-w-[70px]">
...
<span className="text-xs font-black text-blue-400 leading-none mt-1 inline-block">
{rdData.ptsc}
</span>
</div>
<div className="text-center bg-black/60 px-3 py-1.5 rounded-xl border border-white/5 min-w-[70px]">
...
<span className="text-xs font-black text-orange-500 leading-none mt-1 inline-block">
{rdData.booyahs}
</span>
</div>
</div>
...
<th className="px-4 py-2.5 text-center text-orange-500">
Pts Pos
</th>
<th className="px-4 py-2.5 text-center text-red-500">
Abates
</th>
<th className="px-4 py-2.5 text-center">
Booyah
...
<tr
className={`hover:bg-white/[0.02] transition-colors ${isExpanded ? "bg-yellow-500/5" : ""}`}
>
<td className="px-4 py-3 font-semibold text-gray-400">
Queda {m.Q}
</td>
<td className="px-4 py-3 font-bold text-white uppercase italic tracking-wider text-[10px]">
{m.MAPA}
</td>
<td className="px-4 py-3 text-center">
<span
className={`inline-flex items-center justify-center w-7 h-7 rounded-lg font-black italic text-xs border ${parseInt(m.POS) === 1 ? "bg-yellow-500 text-black border-yellow-600" : "bg-gray-950 text-gray-400 border-gray-800"}`}
>
{m.POS}º
</span>
</td>
<td className="px-4 py-3 text-center font-black text-yellow-500">
{m.PTS}
</td>
...
<td className="px-4 py-3 text-center">
{parseInt(m.B) > 0 ? (
<span className="bg-yellow-500 text-black px-1.5 py-0.5 rounded font-black text-[8px] uppercase tracking-tighter">
BOOYAH
</span>
) : (
<span className="text-gray-700 font-bold">
...
<Calendar
size={40}
className="text-yellow-500 mx-auto opacity-70 mb-4"
/>
<h4 className="text-white font-black uppercase italic tracking-widest text-sm">
Nenhuma Equipe Selecionada
</h4>
<p className="text-xs text-gray-500 font-medium mt-1">
Escolha uma equipe abaixo ou na barra superior para listar
suas rodadas.
</p>
</div>
...
key={t.name}
onClick={() =>
setFilters((prev) => ({ ...prev, team: [t.name] }))
}
...
<span className="text-xs font-black uppercase tracking-tight text-white group-hover:text-yellow-500 transition-colors">
{t.name}
</span>
<span className="text-[8px] text-yellow-500/60 font-black uppercase mt-1 block">
{t.pts} PTS
</span>
</div>
))}
...
Filtre por habilidade ativa, veja quais times mais utilizam,
a quantidade total de vezes, média por queda e % de
utilização da line-up.
</p>
</div>
</div>
</div>
...
<img
src={activeSkillsAnalysis.kpis.topSkill.img}
alt={activeSkillsAnalysis.kpis.topSkill.name}
className="w-full h-full object-contain"
/>
) : (
...
{activeSkillsAnalysis.kpis.topSkill?.count || 0} escolhas
</span>
</div>
</div>
</div>
...
<img
src={activeSkillsAnalysis.kpis.topTeam.logo}
alt={activeSkillsAnalysis.kpis.topTeam.teamName}
className="w-full h-full object-contain"
/>
) : (
...
{activeSkillsAnalysis.kpis.topTeam?.count || 0}x no total
</span>
<span className="text-[10px] text-gray-500">
({activeSkillsAnalysis.kpis.topTeam?.avgPerDrop || 0}
/queda)
</span>
</div>
</div>
...
<p className="text-[10px] text-gray-400 mt-1 font-bold">
{activeSkillsAnalysis.allActiveSkills.length} habilidades
ativas diferentes registradas
</p>
</div>
</div>
</div>
...
>
<option value="ALL">
Todas as Habilidades Ativas (
{activeSkillsAnalysis.allActiveSkills.length})
</option>
...
onChange={(e) =>
setActiveSkillMinUsageFilter(e.target.checked)
}
...
{activeSkillsAnalysis.allActiveSkills.map((s) => {
const isSelected =
normalize(selectedActiveSkillFilter) === normalize(s.name);
return (
<button
key={s.key}
...
<span>{s.name}</span>
<span
className={`text-[10px] px-1.5 py-0.2 rounded ${isSelected ? "bg-black/20 text-black font-black" : "bg-white/10 text-gray-400 font-normal"}`}
>
{s.count}
</span>
</button>
...
<img
src={findDimImg(data.hab1, selectedActiveSkillFilter)}
alt={selectedActiveSkillFilter}
className="w-10 h-10 object-contain bg-black rounded-xl p-1 border border-yellow-500/40"
/>
) : (
...
<strong>
{
activeSkillsAnalysis.teamsList.filter((t) => t.count > 0)
.length
}
</strong>{" "}
times utilizam
...
<BarChart2 size={16} className="text-yellow-400" /> Ranking de
Uso por Equipe (
{selectedActiveSkillFilter === "ALL"
? "Total de Ativas"
: selectedActiveSkillFilter}
...
<ResponsiveContainer width="100%" height="100%">
<BarChart
data={activeSkillsAnalysis.teamsList.slice(0, 15)}
...
value,
name === "count" ? "Quantidade" : "Média/Queda",
]}
...
<div
key={team.teamName}
className="bg-[#18181b] rounded-3xl p-6 border border-white/10 hover:border-yellow-500/40 transition-all shadow-xl space-y-4 relative overflow-hidden group"
>
...
<div>
<div className="flex items-center gap-2">
<span className="text-[9px] font-black text-yellow-500 bg-yellow-500/10 px-2 py-0.5 rounded uppercase">
#{idx + 1}
</span>
{team.grupo && (
...
<div>
<span className="text-[8px] font-black text-gray-500 uppercase block mb-0.5">
Quantidade
</span>
<span className="text-xl font-black italic text-yellow-400">
{team.count}x
</span>
</div>
<div>
...
<span className="text-yellow-400 font-bold">
{team.pctDrops}% ({team.dropsWithSkill}/
{team.totalDrops} quedas)
</span>
</div>
<div className="h-2 w-full bg-black rounded-full overflow-hidden border border-white/5">
<div
className="h-full bg-gradient-to-r from-yellow-500 to-amber-500 rounded-full"
style={{ width: `${Math.min(team.pctDrops, 100)}%` }}
/>
</div>
</div>
...
<div
key={p.name}
className="flex items-center gap-1.5 bg-black/50 px-2 py-1 rounded-lg border border-white/5 text-xs font-bold"
>
{p.img && (
<img
src={p.img}
...
<div
key={s.name}
className="flex items-center gap-1.5 bg-black/60 px-2.5 py-1 rounded-xl border border-white/10 text-xs font-bold"
>
{s.img && (
<img
src={s.img}
...
<span className="text-yellow-400 font-black text-[10px] bg-yellow-500/10 px-1.5 rounded">
{s.count}x
</span>
</div>
))}
...
{team.topSkill.img && (
<img
src={team.topSkill.img}
alt={team.topSkill.name}
className="w-4 h-4 object-contain rounded"
/>
)}
...
<span
key={p.name}
className="text-[10px] bg-black/40 px-1.5 py-0.5 rounded border border-white/5 font-bold text-gray-300"
>
{p.name} ({p.count}x)
</span>
))}
...
<div className="text-right">
<h3 className="text-xl font-black italic text-white uppercase leading-none group-hover:text-yellow-500 transition-colors">
...
return (
<div
className={`flex items-center gap-1 px-2 py-0.5 rounded-full border ${char.bg} ${char.border} ${char.color} text-[8px] font-black uppercase tracking-widest`}
>
{char.icon}
{char.label}
</div>
...
<div className="text-[10px] font-black text-yellow-500/50 uppercase tracking-widest group-hover:text-yellow-500 transition-colors">
VER PERFIL COMPLETO →
</div>
</div>
</div>
...
<span className="block text-[10px] text-gray-500 font-black uppercase tracking-widest mb-1">
{label}
</span>
...
<div className="flex flex-col">
<span className="text-xs font-bold text-gray-300 uppercase italic group-hover:text-white transition-colors leading-none">
{team.name}
</span>
{(() => {
const char = getTeamCharacteristic(
...
return (
<div
className={`flex items-center gap-1 mt-1 ${char.color} text-[7px] font-black uppercase tracking-widest`}
>
{char.icon}
{char.label}
</div>
...
<div className="text-right">
<span className={`text-sm font-black italic ${color}`}>
{team[metric]}
</span>
<span className="block text-[8px] text-gray-600 font-black uppercase tracking-tighter">
{label}
</span>
</div>
</div>
